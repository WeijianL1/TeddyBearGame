[
   ...
   },
   {
      "id": "4",
      "name": "Hallway",
      "description": "A yellow plastic ball, known as a favourite toy of the family cat, has been left here. The doorway leads to the living room. Say 'take the ball' to take it. Say 'livingroom' to go there. ",
      "motions": [
         {"dir": "BEDROOM", "dest": "2"},
         {"dir": "LIVINGROOM", "dest": "5"}
      ],
      "info": "hallway"
   },
   {
      "id": "5",
      "name": "Livingroom",
      "description": "You ran to the hallway. Chester, the cat, is right here, sleeping sound and quiet. You need to find a way to wake her up.",
      "motions": [
         {"dir": "BEDROOM", "dest": "2"},
         {"dir": "LAPTOP", "dest": "5"}
      ],
